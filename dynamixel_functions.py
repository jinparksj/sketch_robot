...
dxl_lib = cdll.LoadLibrary("C:/Code/sketchrobot/util/dxl_x64_c.dll")  # for windows 64bit
...
#######################################################
write2ByteTxRx = dxl_lib.write2ByteTxRx #important function for communication TX/RX
#######################################################
